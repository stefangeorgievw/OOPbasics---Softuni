    ...
    public class DataMapper
    {
        ...
        public static void SaveUsers(List<User> users)
        {
            ...
            foreach (var user in users)
            {
                ...
                string line = string.Format(categoryFormat, user.Id, user.Username, user.Password, string.Join(',', user.PostIds));
                lines.Add(line);
            }
        ...
        public static void SavePosts(List<Post> posts)
        {
            ...
            foreach (var post in posts)
            {
                ...
                string line = string.Format(categoryFormat, post.Id, post.Title, post.Content, post.CategoryId, post.AuthorId,
        ...
        public static void SaveReplies(List<Reply> replies)
        {
            ...
            {
                const string categoryFormat = "{0};{1};{2};{3}";
                string line = string.Format(categoryFormat, reply.Id, reply.Content, reply.AuthorId, reply.PostId);
